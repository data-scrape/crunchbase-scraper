...
**Crunchbase Scraper** — Scrape Crunchbase companies, funding, and investor data

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/crunchbase-scraper?style=social)
...
>
> **Search intent:** collect public Crunchbase data for account research, CRM enrichment, and lead qualification. Related topics: business scraper, crunchbase data, web scraping, python, data extraction.

## What this project is for

`crunchbase-scraper` is an implementation-focused Python project for collecting public Crunchbase data. It is designed around one practical job: turn a query such as **"B2B SaaS companies"** into structured records you can inspect, export, and pass into an automation workflow.
...
```bash
git clone https://github.com/data-scrape/crunchbase-scraper.git
...
```json
{
  ...
  "result": {
    ...
    "metadata": {"platform": "Crunchbase", "category": "Business Data Scrapers"}
  }
}
```
